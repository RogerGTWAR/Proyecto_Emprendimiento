...
VALUES
('Diseño', 'Departamento encargado de la creacion visual, diseño gráfico y desarrollo de identidad corporativa.', 1),
('Ventas', 'Departamento responsable de la gestión de clientes y cierre de negocios.', 1),
('Marketing', 'Departamento orientado a la promoción, posicionamiento y publicidad de productos o servicios.', 1),
('Producción', 'Departamento encargado de la elaboración de bienes y servicios, controlando procesos y calidad.', 1),
('Recursos Humanos', 'Departamento responsable de la gestión de personal, contratación, capacitación y clima laboral.', 1),
('Finanzas', 'Departamento encargado de la planificación, control y gestión financiera de la empresa.', 1);
